function Set() {
    ...
    //     let lookupObj = {};
    //     let unionSet = collection
    //     let otherSetValues = otherSet.values();
    //     unionSet.forEach(item => lookupObj[item] = item)
    //     for(let i = 0; i < otherSetValues.length; i += 1){
    //         if(!lookupObj[otherSetValues[i]]){
    //             unionSet.push(otherSetValues[i]);
    //         }
    //     }
